...
const navItems = [
  ...
  { label: "Docs", href: "https://github.com/kirii86/CodeWinOptimizer" },
];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-bg-dark/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-3">
          <span className="h-8 w-8 rounded-lg bg-neon flex items-center justify-center text-bg-dark font-bold text-sm">
            CW
          </span>
